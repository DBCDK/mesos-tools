...
cat 001-create.json | $DEPLOYER --baseurl $MARATHON_HOST --access-token $ACCESS_TOKEN -
...
cat 002-scale.json | $DEPLOYER --baseurl $MARATHON_HOST --access-token $ACCESS_TOKEN -
...
cat 003-update-no-scale.json | $DEPLOYER --baseurl $MARATHON_HOST --access-token $ACCESS_TOKEN -
...
cat 004-suspend.json | $DEPLOYER --baseurl $MARATHON_HOST --access-token $ACCESS_TOKEN -
